  ...
  "src/Math.ts"() {
    ...
    */
    ...
    Scalar.from_bytes = /* @__PURE__ */ __name(function(buffer) {
      ...
      return new _Scalar(new BN2(buffer));
    }, "from_bytes");
    /**
     *  get length of BN
     */
...
var require_src = __commonJS({
  "src/index.js"(exports, module) {
    ...
    function SHA256(obj) {
      ...
      return new Scalar(new BN2(hash));
    }
    ...
    function decryptData(privateKey, obj) {
      ...
      var key = CryptoJS.enc.Utf8.parse(Proxy2.to_hex(symKey.to_bytes()));
